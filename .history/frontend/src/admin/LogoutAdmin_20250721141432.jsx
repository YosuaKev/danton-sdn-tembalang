        ...
        <div className="w-full max-w-md">
          ...
          <div className="bg-gray-100 rounded-2xl p-6 border border-gray-300 shadow-xl">
            ...
            <button
              ...
              className="w-full py-4 px-6 bg-gradient-to-r from-red-400 to-red-500 hover:from-red-500 hover:to-red-400 text-white font-semibold rounded-xl shadow-lg transition-all duration-300 focus:outline-none focus:ring-4 focus:ring-red-400/30 text-lg transform hover:scale-[1.02] hover:shadow-xl"
            >
              Sign Out
            </button>
          </div>
