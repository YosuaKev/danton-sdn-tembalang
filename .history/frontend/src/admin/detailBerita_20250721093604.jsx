...
const DetailBerita = () => {
  ...
  const token = localStorage.getItem("token"); // Dideklarasikan sebelum useEffect
...
useEffect(() => {
    ...
    fetchBerita();
  }, [id, navigate, token]); // ✅ token ditambahkan ke dependency array

  // Cegah render jika tidak ada token
  if (!token) {
    return null;
  }
