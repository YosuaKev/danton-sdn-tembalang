...
const BeritaAdmin = () => {
  ...
  const delayFetch = async () => {
    ...
    if (!token) {
      console.error("Token tidak tersedia. Redirecting...");
      return; // Tidak memanggil fetch jika token tidak ada
    }

    fetchBeritas(); // Pastikan fetchBeritas menggunakan token dari localStorage
  };
