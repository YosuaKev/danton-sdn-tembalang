  ...
  return (
    <div className="bg-white text-black min-h-screen w-full">
      ...
      <div className="p-6 md:p-8">
        <button
          onClick={backSign}
          className="flex items-center text-gray-600 hover:text-black transition-colors duration-200 group"
      ...
      <div className="flex flex-col items-center justify-center px-6 py-8 md:py-16">
        <div className="w-full max-w-md">
          ...
          {/* Logout Section */}
          <div className="bg-gray-100 rounded-2xl p-8 border border-gray-300 shadow-xl">
            <div className="text-center mb-8">
              <h1 className="text-xl md:text-2xl font-bold mb-4">Ready to sign out?</h1>
              <p className="text-gray-600 leading-relaxed">
                You'll be securely logged out of your account. You can sign back in anytime.
              </p>
            </div>
...
export default LogoutPageWhite;
